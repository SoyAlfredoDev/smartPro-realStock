...
export const privacyPolicySections = [
  {
    ...
    paragraphs: [
      ...
      `${siteConfig.name} adopta de manera anticipada los principios y estándares de esta ley en sus procesos de suscripción, newsletter y uso de la plataforma.`,
    ],
  },
  {
    id: "responsable",
    ...
    paragraphs: [
      ...
      "Para consultas relacionadas con privacidad y protección de datos puede contactarnos a través de los canales publicados en el sitio, en horario de atención de lunes a viernes de 9:00 a 18:00 hrs.",
    ],
  },
  {
    ...
    list: [
      "Datos de identificación y contacto: nombre y correo electrónico cuando se suscribe al newsletter o solicita información.",
      "Datos de cuenta o membresía: preferencias de catálogo, colecciones y uso de la plataforma, cuando corresponda.",
      "Datos de navegación y uso: dirección IP, tipo de dispositivo, navegador, páginas visitadas, cookies y eventos de interacción.",
      "Datos derivados de solicitudes de soporte o contacto vinculadas a la plataforma.",
    ],
  },
  {
    id: "finalidades",
    ...
    list: [
      "Permitir el acceso a contenido audiovisual, catálogo y colecciones de RealStock.",
      "Gestionar suscripciones, newsletter y comunicaciones autorizadas sobre novedades visuales.",
  ...
  },
  {
    ...
    paragraphsAfter: [
      "Para ejercer sus derechos, contáctenos a través de los canales publicados en el sitio indicando su nombre, RUT y el derecho que desea ejercer. Responderemos dentro de los plazos que establezca la normativa vigente.",
    ],
  },
  {
    id: "cesion",
    ...
    list: [
      ...
      "Proveedores de infraestructura o distribución de contenido audiovisual, cuando sea necesario para prestar el servicio.",
    ],
    paragraphsAfter: [
...
export const privacyPolicyContactCta = {
  ...
  description:
    "Si deseas acceder, rectificar o eliminar tus datos personales, contáctanos a través de los canales del sitio y responderemos conforme a los plazos de la Ley N° 21.719.",
} as const;
